...
if("TRUE" STREQUAL "TRUE")
  set(clear_costmap_recovery_SOURCE_PREFIX /home/sundong/Exploring/localplanning/ros_navigation_stack_vrep_simulation/src/Navigation/clear_costmap_recovery)
  set(clear_costmap_recovery_DEVEL_PREFIX /home/sundong/Exploring/localplanning/ros_navigation_stack_vrep_simulation/devel/.private/clear_costmap_recovery)
  ...
  set(clear_costmap_recovery_INSTALL_PREFIX /home/sundong/Exploring/localplanning/ros_navigation_stack_vrep_simulation/install)
...
if(NOT "/home/sundong/Exploring/localplanning/ros_navigation_stack_vrep_simulation/src/Navigation/clear_costmap_recovery/include " STREQUAL " ")
  set(clear_costmap_recovery_INCLUDE_DIRS "")
  set(_include_dirs "/home/sundong/Exploring/localplanning/ros_navigation_stack_vrep_simulation/src/Navigation/clear_costmap_recovery/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'clear_costmap_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sundong/Exploring/localplanning/ros_navigation_stack_vrep_simulation/src/Navigation/clear_costmap_recovery/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/sundong/Exploring/localplanning/ros_navigation_stack_vrep_simulation/devel/.private/clear_costmap_recovery/lib;/home/sundong/Exploring/localplanning/ros_navigation_stack_vrep_simulation/devel/lib;/home/sundong/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
