...
class BrakeCmd(genpy.Message):
  _md5sum = "4b6c57c74f8e12f7f2af7f00a7897290"
...
"""
  ...
  __slots__ = ['pedal_cmd','pedal_cmd_type','boo_cmd','enable','ignore','count']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       pedal_cmd,pedal_cmd_type,boo_cmd,enable,ignore,count
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_f5B().pack(_x.pedal_cmd, _x.pedal_cmd_type, _x.boo_cmd, _x.enable, _x.ignore, _x.count))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.pedal_cmd, _x.pedal_cmd_type, _x.boo_cmd, _x.enable, _x.ignore, _x.count,) = _get_struct_f5B().unpack(str[start:end])
