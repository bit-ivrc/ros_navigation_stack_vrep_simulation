...
class ThrottleCmd(genpy.Message):
  _md5sum = "dbda92d4b5ebb3cb2a081198c88bc62f"
...
"""
  ...
  __slots__ = ['pedal_cmd','pedal_cmd_type','enable','ignore','count']
  _slot_types = ['float32','uint8','bool','bool','uint8']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       pedal_cmd,pedal_cmd_type,enable,ignore,count
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_f4B().pack(_x.pedal_cmd, _x.pedal_cmd_type, _x.enable, _x.ignore, _x.count))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.pedal_cmd, _x.pedal_cmd_type, _x.enable, _x.ignore, _x.count,) = _get_struct_f4B().unpack(str[start:end])
