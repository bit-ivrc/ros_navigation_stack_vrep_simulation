...
"""autogenerated by genpy from anm_msgs/DynamicObstacleList.msg. Do not edit."""
import sys
...
class DynamicObstacleList(genpy.Message):
  _md5sum = "3435c2c322edb674d240f51d9feb64aa"
  _type = "anm_msgs/DynamicObstacleList"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# Dynamic obstacle list custom message 
Header header
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','anm_msgs/DynamicObstacle[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DynamicObstacleList, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.obstacles:
        ...
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _x = val1
        buff.write(_get_struct_2f().pack(_x.speed, _x.yaw))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = anm_msgs.msg.DynamicObstacle()
        _v3 = val1.position
        _x = _v3
        start = end
        end += 24
        ...
        (_x.speed, _x.yaw,) = _get_struct_2f().unpack(str[start:end])
