    ...
    {
        publisherProxy->publisher = nh->advertise<anm_msgs::CommandCheckingReport>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "anm_msgs/DynamicObstacle")
    {
        publisherProxy->publisher = nh->advertise<anm_msgs::DynamicObstacle>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "anm_msgs/DynamicObstacleList")
    {
        publisherProxy->publisher = nh->advertise<anm_msgs::DynamicObstacleList>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "anm_msgs/HMIReport")
    {
        publisherProxy->publisher = nh->advertise<anm_msgs::HMIReport>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "anm_msgs/NearestAnmWaypoint")
    {
        publisherProxy->publisher = nh->advertise<anm_msgs::NearestAnmWaypoint>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "anm_msgs/PathState")
    {
        publisherProxy->publisher = nh->advertise<anm_msgs::PathState>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "anm_msgs/ShuttleRequest")
    {
        publisherProxy->publisher = nh->advertise<anm_msgs::ShuttleRequest>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "anm_msgs/SpiralPath")
    {
        publisherProxy->publisher = nh->advertise<anm_msgs::SpiralPath>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "anm_msgs/SystemState")
    {
        publisherProxy->publisher = nh->advertise<anm_msgs::SystemState>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "anm_msgs/V2XStopSign")
    {
        publisherProxy->publisher = nh->advertise<anm_msgs::V2XStopSign>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "anm_msgs/V2XStopSignList")
    {
        publisherProxy->publisher = nh->advertise<anm_msgs::V2XStopSignList>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "anm_msgs/V2XTrafficLight")
    {
        publisherProxy->publisher = nh->advertise<anm_msgs::V2XTrafficLight>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "anm_msgs/V2XTrafficLightList")
    {
        publisherProxy->publisher = nh->advertise<anm_msgs::V2XTrafficLightList>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "anm_msgs/V2XVehicle")
    {
        publisherProxy->publisher = nh->advertise<anm_msgs::V2XVehicle>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "anm_msgs/V2XVehicleList")
    {
        publisherProxy->publisher = nh->advertise<anm_msgs::V2XVehicleList>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "anm_msgs/VehicleState")
    {
        publisherProxy->publisher = nh->advertise<anm_msgs::VehicleState>(in->topicName, in->queueSize, in->latch);
    }
    ...
    {
        publisherProxy->publisher = nh->advertise<dbw_mkz_msgs::AmbientLight>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "dbw_mkz_msgs/BrakeCmd")
    {
        publisherProxy->publisher = nh->advertise<dbw_mkz_msgs::BrakeCmd>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "dbw_mkz_msgs/BrakeInfoReport")
    {
        publisherProxy->publisher = nh->advertise<dbw_mkz_msgs::BrakeInfoReport>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "dbw_mkz_msgs/BrakeReport")
    {
        publisherProxy->publisher = nh->advertise<dbw_mkz_msgs::BrakeReport>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "dbw_mkz_msgs/FuelLevelReport")
    {
        publisherProxy->publisher = nh->advertise<dbw_mkz_msgs::FuelLevelReport>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "dbw_mkz_msgs/Gear")
    {
        publisherProxy->publisher = nh->advertise<dbw_mkz_msgs::Gear>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "dbw_mkz_msgs/GearCmd")
    {
        publisherProxy->publisher = nh->advertise<dbw_mkz_msgs::GearCmd>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "dbw_mkz_msgs/GearReport")
    {
        publisherProxy->publisher = nh->advertise<dbw_mkz_msgs::GearReport>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "dbw_mkz_msgs/HillStartAssist")
    {
        publisherProxy->publisher = nh->advertise<dbw_mkz_msgs::HillStartAssist>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "dbw_mkz_msgs/Misc1Report")
    {
        publisherProxy->publisher = nh->advertise<dbw_mkz_msgs::Misc1Report>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "dbw_mkz_msgs/ParkingBrake")
    {
        publisherProxy->publisher = nh->advertise<dbw_mkz_msgs::ParkingBrake>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "dbw_mkz_msgs/SteeringCmd")
    {
        publisherProxy->publisher = nh->advertise<dbw_mkz_msgs::SteeringCmd>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "dbw_mkz_msgs/SteeringReport")
    {
        publisherProxy->publisher = nh->advertise<dbw_mkz_msgs::SteeringReport>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "dbw_mkz_msgs/SurroundReport")
    {
        publisherProxy->publisher = nh->advertise<dbw_mkz_msgs::SurroundReport>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "dbw_mkz_msgs/SuspensionReport")
    {
        publisherProxy->publisher = nh->advertise<dbw_mkz_msgs::SuspensionReport>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "dbw_mkz_msgs/ThrottleCmd")
    {
        publisherProxy->publisher = nh->advertise<dbw_mkz_msgs::ThrottleCmd>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "dbw_mkz_msgs/ThrottleInfoReport")
    {
        publisherProxy->publisher = nh->advertise<dbw_mkz_msgs::ThrottleInfoReport>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "dbw_mkz_msgs/ThrottleReport")
    {
        publisherProxy->publisher = nh->advertise<dbw_mkz_msgs::ThrottleReport>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "dbw_mkz_msgs/TirePressureReport")
    {
        publisherProxy->publisher = nh->advertise<dbw_mkz_msgs::TirePressureReport>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "dbw_mkz_msgs/TurnSignal")
    {
        publisherProxy->publisher = nh->advertise<dbw_mkz_msgs::TurnSignal>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "dbw_mkz_msgs/TurnSignalCmd")
    {
        publisherProxy->publisher = nh->advertise<dbw_mkz_msgs::TurnSignalCmd>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "dbw_mkz_msgs/TwistCmd")
    {
        publisherProxy->publisher = nh->advertise<dbw_mkz_msgs::TwistCmd>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "dbw_mkz_msgs/WatchdogCounter")
    {
        publisherProxy->publisher = nh->advertise<dbw_mkz_msgs::WatchdogCounter>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "dbw_mkz_msgs/WheelSpeedReport")
    {
        publisherProxy->publisher = nh->advertise<dbw_mkz_msgs::WheelSpeedReport>(in->topicName, in->queueSize, in->latch);
    }
    else if(in->topicType == "dbw_mkz_msgs/Wiper")
    {
        publisherProxy->publisher = nh->advertise<dbw_mkz_msgs::Wiper>(in->topicName, in->queueSize, in->latch);
    }
